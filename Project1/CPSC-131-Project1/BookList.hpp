...
public:
	...
	std::size_t find( const Book & book ) const; // TO DO
	 // returns the (zero-based) offset from top of list where the book is found, or the size of the list if the book is not found
